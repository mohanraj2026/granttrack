...
/**
 * Read-only projection of the award-owned {@code grant_awards} table (authoritative copy and
 * all writes live in core-service). Finance reads award amount/status/finance-review fields to
 * gate milestone creation and fund releases via the shared database.
 */
@Entity
