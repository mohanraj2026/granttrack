...
/**
 * Forwards notifications to notification-service via Feign. Best-effort: a notification-service
 * outage must never roll back or fail the disbursement operation that triggered the notification,
 * so all delivery failures are logged and swallowed.
 */
@Service
