...
/**
 * System user. Read-only projection of the identity-owned {@code users} table
 * (authoritative copy and all writes live in auth-service). Core maps it so award and
 * review can resolve principal-investigator / staff details via the shared database.
 */
@Entity
